...
const { signUp, findUsers, deleteUser, updateUser } = require("./controllers"); // import only signupp from controllers
...
userRouter.patch("/user", updateUser) // defining a delete request on /user path
